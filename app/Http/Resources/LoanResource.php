...
class LoanResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'guarantor_name' => ($this->relationLoaded('guarantorEmployee') ? $this->guarantorEmployee?->full_name : null) ?: $this->guarantor_external_name,
            'guarantor_phone' => $this->guarantor_external_phone,
            'auto_deduct_from_payroll' => (bool) $this->auto_deduct_from_payroll,
            'status' => $this->status,
