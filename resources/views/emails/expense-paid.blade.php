...
<p>Your approved expense reimbursement has been <strong style="color:#4F46E5;">paid</strong>. Please check your account:</p>
...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#F8F9FF; border-radius:12px; border:1px solid #E0E7FF; margin:20px 0; overflow:hidden;">
  <tr>
    <td style="background:linear-gradient(135deg,#4F46E5,#7C3AED); padding:14px 24px;">
      <span style="color:#fff; font-weight:700; font-size:15px;">Payment Confirmation</span>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="padding:0 24px 20px;">
      <div style="background:linear-gradient(135deg,#4F46E5,#7C3AED); border-radius:10px; padding:16px 20px; text-align:center;">
        <div style="font-size:12px; color:rgba(255,255,255,0.75); text-transform:uppercase; letter-spacing:1px;">Amount Paid</div>
...
<p style="color:#374151; font-size:14px;">If you have any questions about this payment, please contact HR.</p>
