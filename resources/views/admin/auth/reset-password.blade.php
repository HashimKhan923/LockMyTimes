...
<div class="text-white">
    ...
    <p class="text-white/75 text-sm leading-relaxed">
        Pick something strong and memorable — you'll use it every time you sign in to your admin workspace.
    </p>
</div>
@endsection
...
<form action="{{ route('admin.password.reset.post', $tenantModel->slug) }}" method="POST" class="space-y-5">
    @csrf
