...
<div class="text-white">
    ...
    <h2 class="text-3xl font-black mb-3" style="font-family:'Nunito',sans-serif">Almost there!</h2>
    <p class="text-white/75 text-sm leading-relaxed">
        Set your personal password to complete your account setup.
    </p>
</div>
@endsection
...
<div class="mb-8">
    ...
    <h1 class="text-2xl font-black text-ink mb-2" style="font-family:'Nunito',sans-serif">Create your password</h1>
    <p class="text-ink-soft text-sm">You'll use this to sign in to your employee portal.</p>
</div>

<form action="{{ route('employee.password.change.post', $tenantSlug) }}" method="POST" class="space-y-5">
    @csrf
