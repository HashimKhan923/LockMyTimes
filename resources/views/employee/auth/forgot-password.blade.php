...
<div class="text-white">
    ...
    <p class="text-white/75 text-sm leading-relaxed">
        No problem — enter the email address on your account and we'll send you a link to reset it.
    </p>
</div>
@endsection
...
<div class="mb-8">
    <div class="w-12 h-12 rounded-xl bg-emerald-50 flex items-center justify-center mb-4">
        <i data-lucide="mail-question" class="w-6 h-6 text-emerald-600"></i>
    </div>
...
<form action="{{ route('employee.password.forgot.post', $tenantModel->slug) }}" method="POST" class="space-y-5">
    @csrf
